        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="ord.php">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title" class="active" >Ordonnance</span>
            </a>
          </li>
          <li class="nav-item">
...
$query_count = "SELECT COUNT(*) AS num_rows FROM ordonnance";
...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
      <input type="text" id="search-date" placeholder="Search by date" class="">
       <script>
  ...
  $('#search-date').on('keyup', function() {
    ...
    $.ajax({
      ...
      success: function(response) {
        $('tbody').html(response);
        // Reset page to 1 when search input is cleared
        if (date === '') {
          ...
          <tbody>
            <?php foreach ($data as $row): ?>
                <tr>
                  ...
                  <td><?= $row['nombre_fois'] ?></td>
                  <td><?= $row['doctor_name'] ?></td>
                  <td>
                    <form action="delete_ord.php" method="POST">
                      <button type="submit" name="delete" value="<?= $row['ido'] ?>" class="btn btn-danger">Delete</button>
                    </form>
                  </td>
                </tr>
            <?php endforeach; ?>
