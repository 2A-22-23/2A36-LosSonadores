  ...
  <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <ul>
                ...
                <li><a href="./Impact/update.php">Update your account</a></li>
              </ul>
        </li>
...
// Query to retrieve the image path based on $doctorId
$query = "SELECT image FROM user WHERE idclient = :doctorId";
...
if ($statement->execute()) {
    ...
    // Output the image tag with the image path
    echo '<img src="' . $imagePath . '" alt="' . $doctorNom . '">';
} else {
    // Handle the case when the query fails
    echo 'Error retrieving image path from the database.';
}
?>
...
if ($statement->execute()) {
    ...
    // Output the image tag with the image path
    echo '<img src="' . $imagePath . '" alt="' . $doctorNom . '" width="200">';
