 ...
 <head>
  ...
  $(document).ready(function() {
   var calendar = $('#calendar').fullCalendar({
    ...
    events: 'loadd.php?idclient=<?php echo $_SESSION['idclient']; ?>',

    selectable:true,
    selectHelper:true,
    select: function(start, allDay, event) // ajout de event en troisième paramètre
{
 ...
 if(title)
 {
  $.ajax({
   ...
   data:{ 
     title:title,
     idr:event.idr // ajout de l'ID dans le tableau data
   },
   success:function()
   {
