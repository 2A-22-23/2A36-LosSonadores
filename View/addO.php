    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          ?>
          <ul>
                  <li><a href="/FIRST_SUII/tojrab03/views/Impact/show_user.php">Show your account infos</a></li>
	...
	<div class="wrapper">
		...
		<div class="main_container">
			...
			<div class="container">
				 <div class="content">
					<div class="content">
						<form method="post" action="add_ordonnance.php" onsubmit="return errorMessage()">	
						<div class="user-details">
						 <div class="input-box">
  								<span class="details">Medical record id</span>
  									<select name="medical_id" id="medical">
                ...
                <span id="error9" style="display:none;"></span>
                     ...
                     <br>
                     <form method="post" action="delete_ordonnance.php">	
					 <a href="#" id="search-link"><strong>Delete ordonnance ?</strong></a>
                     <br>
<div id="search-form" class="search-form">
  <div class="input-box">
    <span class="details">Patient Name</span>
    <select name="patient_name2" id="patient_name2">
