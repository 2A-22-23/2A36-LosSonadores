...
include  "C:/xampp/htdocs/First_SUII/projet/Controller/ProduitC.php";
              ...
              <?php
                        ...
                        foreach($result as $row){ ?>
                          ...
                          <div class="product_box">
                            ...
                            <img src="./skydash-free-bootstrap-admin-template-main/template/<?php echo $row['image'] ?>" class="image_1" style="width:224px;height: 280px;">
                            <div class="btn_main">
