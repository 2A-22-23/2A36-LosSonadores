    ...
    <div class="container position-relative">
      <div class="row gy-5" data-aos="fade-in">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
          <h2>Welcome to <span>Doctor side</span></h2>
...
<style>
  ...
  .section-header .img-container .text-container {
    position: absolute;
    top: 50%;
    left: 50%;
  ...
  .section-header .img-container h2 {
    font-size: 3rem;
    color: #fff;
    margin-bottom: 1rem;
  }
  
  .section-header .img-container .btn {
    display: inline-block;
    padding: 1.2rem 3rem;
  ...
  .section-header .img-container .btn:hover {
  ...
  <section id="medical_record">
      <div class="section-header">
        <div class="img-container">
          <img src="assets/img/dossier.jpg" weight = "1250" height = "1000" alt="Medical Record">
          <div class="text-container">
            <h2><strong>MEDICAL RECORD</strong></h2>
            <a class="btn" href="add.php">ENTER</a>
          </div>
        </div>
      </div>
  </section><!-- End medical record Section -->

  <section id=Ordonnance class ="portfolio sections-bg">
    <div class="section-header">
      <div class="img-container">
        <img src="assets/img/ordonnance.jpeg" weight = "1250" height = "1000" alt="Medical Record">
        <div class="text-container">
          <h2><strong>Ordonnance</strong></h2>
          <a class="btn" href="addO.php">ENTER</a>
        </div>
      </div>
    </div>
</section><!-- End medical record Section -->
