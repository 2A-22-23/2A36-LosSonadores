...
require_once('C:/xampp/htdocs/FIRST_SUII/projet/View/tojrab03/PHPMailer-master/src/PHPMailer.php');
...
move_uploaded_file($tempname, $folder);
     ...
     $client = new client($nom,$prenom,$type,$telephone,$adresse,$email,$login,$mdp, $folder,$code);
        ...
        $mail->Port = 587;
             ...
             $mail->Body    = 'Here is the verification link <b><a href=http://localhost:8012/FIRST_SUII/projet/View/Impact/verif.php?verification='.$code.'">http://localhost:8012/FIRST_SUII/projet/View/Impact/login.php?verification='.$code.'</a></b>';
// 80443
             $mail->send();
