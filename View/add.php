...
<section id="topbar" class="topbar d-flex align-items-center">
  ...
  <header id="header" class="header d-flex align-items-center">
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      <a href="add.php" class="logo d-flex align-items-center">
...
var hamburger = document.querySelector(".hamburger");
	...
	backdrop.addEventListener("click", function(){
		wrapper.classList.remove("active");
				 ...
				 <div class="content">
					<div class="content">
						<form method="post" action="add_medical_record.php" onsubmit="return errorMessage()">	
						<div class="user-details">
						 <div class="input-box">
  								<span class="details">Patient code</span>
  									<select name="patient_code" id="patient_code">
    								<option value=" ">Select a code</option>
  									</select>
							</div>
						  <div class="input-box">
							<span class="details">Phone Number</span>
							<input type="text" name="phone_number" placeholder="Enter phone number" value="+216" >
							<span id="error3" style="display:none;"></span>
						  </div>
						  <div class="input-box">
							<span class="details">Weigth</span>
							<input type="text" name="weight" placeholder="Enter the patient weigth" >
							<span id="error5" style="display:none;"></span>
						  </div>
						  <div class="input-box">
							<span class="details">Heigth</span>
							<input type="text" name="height" placeholder="Enter the patient heigth" >
						  ...
						  <div class="input-box">
							<span class="details">Patient Birthday</span>
							<input type="date" name="birth_date" id="birthday" max="2005-12-31" min="1920-12-31">
							<span id="error9" style="display:none;"></span>
						  </div>
						  <div class="input-box">
  ...
  <select name="sexe">
    ...
    <option value="other">Other</option>
           ...
           <br>
                     <form method="post" action="delete_dossier.php">	
					 <a href="#" id="search-link"><strong>Delete medical record ?</strong></a>
                     <br>
