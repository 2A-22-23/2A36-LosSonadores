    ...
    <tbody>
      <?php foreach ($list as $historique) { ?>
        <tr>
          ...
          <td>
            <button type="button" class="btn btn-inverse-success btn-fw" data-toggle="modal" data-target="#editModal<?= $historique['idhis']; ?>">Modifier</button>
            <a href="deletehist.php?idhis=<?= $historique['idhis']; ?>" class="btn btn-inverse-warning btn-fw">Supprimer</a>
          </td>
        </tr>
...
var chart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      backgroundColor: 'rgba(255, 193, 0, 0.5)', // #FFC100 with opacity 0.5
borderColor: 'rgba(255, 193, 0, 1)', // 
      borderWidth: 1
    }, {
      label: 'Total prix',
      data: <?php echo json_encode($data['total_ventes']); ?>,
      backgroundColor: 'rgba(87, 182, 87, 0.5)', // #57B657 with opacity 0.5
borderColor: 'rgba(87, 182, 87, 1)', //
      borderWidth: 1
    }]
  },
  options: {
