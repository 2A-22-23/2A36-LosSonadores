        ...
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="medical.php">
              ...
              <span class="menu-title" class="active" >Medical Record</span>
            </a>
          </li>
          <li class="nav-item">
...
$query_count = "SELECT COUNT(*) AS num_rows FROM dossier";
...
$query = "SELECT * FROM dossier LIMIT $limit OFFSET $offset";
...
$(document).ready(function() {
  $('#search-ido').on('keyup', function() {
    var date = $(this).val();
    $.ajax({
      url: 'search_dossier.php',
      type: 'POST',
      data: {date: date},
                ...
                <tr>
                  ...
                  <td>
                    <form action="delete_admin.php" method="POST">
                      <button type="submit" name="delete" value="<?= $row['idd'] ?>" class="btn btn-danger">Delete</button>
                    </form>
                  </td>
                </tr>
            <?php endforeach; ?>
