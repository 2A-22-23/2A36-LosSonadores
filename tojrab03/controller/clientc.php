...
include 'C:\xampp\htdocs\atelier_CRUD\atelier_CRUD\tojrab03\entite\client.php';
         ...
         try {
           $con = config::getConnexion();
              ...
              $con->exec($sql);
                   ...
                   header('Location:C:\xampp\htdocs\atelier_CRUD\atelier_CRUD\tojrab03\View\index.php');      
}
...
if (r == true) { 		
    	window.location.replace('C:/xampp/htdocs/tojrab03/views/Impact/login.php');
