      ...
      <!-- partial -->
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Medical record table</p>
                        ...
                        foreach ($data as $row) {
                          ...
                          echo '<td>
                                  <form action="delete_admin.php" method="POST">
                                      <button type="submit" name="delete" value="' . $row['CIN_patient'] . '" class="btn btn-danger">Delete</button>
                                  </form>
                                </td>
                                </tr>';
