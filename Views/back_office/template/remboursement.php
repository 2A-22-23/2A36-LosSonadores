        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="remboursement.php">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title" class="active" >Remboursement</span>
            </a>
          </li>
        </ul>
      </nav>
...
<a href="statistic.php"><strong>Statistic</strong></a>
        <table class="styled-table">
          ...
          <tbody>
            <?php foreach ($data as $row): ?>
              <?php if(empty($searchValue) || $row['id_remb'] === $searchValue): ?>
                <tr>
                  <td><?= $row['id_remb'] ?></td>
                  <td><?= $row['matricule_remb'] ?></td>
                  <td><?= $row['pourcentage_remb'] ?></td>
                  <td><?= $row['age_remb'] ?></td>
                  <td><?= $row['observation_remb'] ?></td>
                  <td><?= $row['cota_remb'] ?></td>
